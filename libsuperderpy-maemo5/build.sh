...
docker commit libsuperderpy-maemo5-deps-build-$UUID dosowisko/libsuperderpy-maemo5:deps
...
docker commit libsuperderpy-maemo5-cmake-build-$UUID dosowisko/libsuperderpy-maemo5:cmake
...
docker commit libsuperderpy-maemo5-sdl2-build-$UUID dosowisko/libsuperderpy-maemo5:sdl2
...
docker commit libsuperderpy-maemo5-allegro5-build-$UUID dosowisko/libsuperderpy-maemo5:allegro5
