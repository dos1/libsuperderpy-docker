...
docker run --privileged --name="libsuperderpy-maemo5-deps-build-$UUID" libsuperderpy-maemo5-deps-temporary:latest /home/admin/install-deps.sh
...
docker run --privileged --name="libsuperderpy-maemo5-cmake-build-$UUID" libsuperderpy-maemo5-cmake-temporary:latest /home/admin/build-cmake.sh
...
docker run --privileged --name="libsuperderpy-maemo5-sdl2-build-$UUID" libsuperderpy-maemo5-sdl2-temporary:latest /home/admin/build-sdl2.sh
...
docker run --privileged --name="libsuperderpy-maemo5-allegro5-build-$UUID" libsuperderpy-maemo5-allegro5-temporary:latest /home/admin/build-allegro5.sh
