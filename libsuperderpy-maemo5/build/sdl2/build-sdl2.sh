...
wget https://dosowisko.net/libsuperderpy/deps/SDL2-2.0.10.tar.gz -O /scratchbox/users/admin/home/admin/sdl2.tar.gz
...
make install
cd ../..
rm -rf SDL2-2.0.10 sdl2.tar.gz build-sdl2.sh
EOF
