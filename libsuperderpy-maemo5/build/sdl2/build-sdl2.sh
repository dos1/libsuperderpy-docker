...
wget https://dosowisko.net/libsuperderpy/deps/SDL2-2.0.14.tar.gz -O /scratchbox/users/admin/home/admin/sdl2.tar.gz
...
make install
cd ../..
rm -rf SDL2-2.0.14 sdl2.tar.gz build-sdl2.sh
EOF
