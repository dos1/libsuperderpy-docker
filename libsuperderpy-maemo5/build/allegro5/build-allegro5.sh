...
wget https://dosowisko.net/libsuperderpy/deps/allegro-5.2.6.0-p1.tar.gz -O /scratchbox/users/admin/home/admin/allegro5.tar.gz
...
make install
cd ../..
rm -rf allegro-5.2.6.0 allegro5.tar.gz build-allegro5.sh
EOF
